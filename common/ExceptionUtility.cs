...
#endif
{
	...
	public static class ExceptionUtility
	{
		...
		private static void ConvertExceptionToFailureInformation(Exception ex, int parentIndex, List<string> exceptionTypes, List<string> messages, List<string> stackTraces, List<int> indices)
		{
		...
		private class FailureInformation : IFailureInformation
		{
