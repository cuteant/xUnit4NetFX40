...
namespace Xunit.Sdk
{
	...
	public static class Reflector
	{
		...
		readonly static MethodInfo EnumerableCast = typeof(Enumerable).GetRuntimeMethodsEx().First(m => m.Name == "Cast");
		readonly static MethodInfo EnumerableToArray = typeof(Enumerable).GetRuntimeMethodsEx().First(m => m.Name == "ToArray");
